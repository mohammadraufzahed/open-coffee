  ...
  return (
    <View style={styles.container}>
      <Text style={styles.paragraph}>
        ...
        نیست. این خیابان، زیاد بزرگ نیست، بنابراین تعجبی ندارد که یک نفر بتواند
        تمام کافه ­های آن را امتحان کند. در این میان ” کافه حس” یکی از محبوب
        ترین کافه­ ها است و طرفداران بسیار زیادی دارد. این کافه همیشه بسیار شلوغ
        است و در بعضی از روزها برای نشستن در آنجا حتماً باید از قبل یک میز را
        رزرو کنید. کافه حس از چند قسمت تشکیل شده است که هر کدام از دیگری زیباتر
        اند.
      </Text>
